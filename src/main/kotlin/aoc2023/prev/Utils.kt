 ...
 */
fun readInput(name: String) = Path("src/main/kotlin/aoc2023/prev/$name.txt").readLines()
fun readInput(day: String, name: String) = Path("src/main/kotlin/aoc2023/day${day}/$name.txt").readLines()
